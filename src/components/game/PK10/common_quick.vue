    ...
    <div class="PK10_common mtBttom">
        <div class="lottery-list">
            <div class="way_Box" v-for="(lab,num) in labels" :key="num">
                <div class="checkbtn">
                    <!--RadioGroup size="large" v-model="lab.quick"  type="button"  @on-change="quickCheck($event,num)">
                        <Radio label="quan">全</Radio>
                        <Radio label="da">大</Radio>
                        <Radio label="xiao">小</Radio>
                        <Radio label="ji">奇</Radio>
                        <Radio label="ou">偶</Radio>
                        <Radio label="qing">清</Radio>
                    </RadioGroup-->
                    <div class="label"></div>
                    <ButtonGroup >
...
export default {
    ...
    methods:{
        ...
        getshowBallName(position,ball){
            ...
            console.log("lottoryArr",JSON.stringify(lottoryArr));
