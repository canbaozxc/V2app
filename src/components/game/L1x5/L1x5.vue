...
<script>
import L1x5DataGameBall from "@/components/game/L1x5/L1x5.js";
import Notice from '@/components/game/Notice.vue'
export default {
    name:'L1x5way',
    components:{
        L1x5noteList:() => import("@/components/game/L1x5/noteList.vue"),
         L1x5hunhe:() => import("@/components/game/L1x5/common_hunhe.vue"),
        // L1x5common:() => import("@/components/game/L1x5/common.vue"),
        L1x5quick:() => import("@/components/game/L1x5/common_quick.vue"),
        // L1x5chi:() => import("@/components/game/L1x5/common_chi.vue"),
        L1x5qiu:() => import("@/components/game/L1x5/common_qiu.vue"),
        Notice,
    },
    ...
    methods:{
        init(data){//初始化所有L1x5玩法数据，模板映射
        //console.log(L1x5DataGameBall);
        if(L1x5DataGameBall[data.series_way_id]){//防止数据延迟，只有数据真正传过来了才能执行
            let dataTpl = {};
            switch (data.series_way_id) {
                default:
                        console.log(L1x5DataGameBall[data.series_way_id]);
                    
                        dataTpl = L1x5DataGameBall[data.series_way_id];
