    ...
    methods:{
        ...
        getTotalBet(betArr){
            ...
            switch (this.dataTpl.the_way) {
                ...
                case "baodan3"://求和计算投注数,两面-按名次
                    asd = this.$lottoryApi.baodan3(betArr[0][0],this.startNum,this.endNum);
                    break;
                case "baodan2"://求和计算投注数,两面-按名次
                    asd = this.$lottoryApi.baodan2(betArr[0][0],this.startNum,this.endNum);
                    break;
                default:
                    break;
            }
