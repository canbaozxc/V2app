<template>
    <div class="verifyCard" id="verifyCard">
        ...
        <Form ref="formInline" :model="formInline" :rules="ruleInline" inline>
                    ...
                    <Row  type="flex" justify="center" align="middle">
                        ...
                        <Col span="16">
                            <FormItem  class="left" prop="bank_num">
                                ...
                                <Select v-model="formInline.bank_num"  placeholder="请选择您要删除的银行卡">
            ...
            <div class="submit">
                <Button type="error" long @click="handleSubmit('formInline')">删除</Button>
            </div>
        </Form>
...
export default {
    ...
    methods:{
        ...
        async deleteBankCard(){
            let pream = {
                card_id:this.formInline.bank_num,
                checked_token:this.$store.getters.getbankToken
            }
            let res = this.$api.deleteBankCard(pream);
            if(res.errno ==0){
                this.$Modal.success({
                    title: "删除成功",
                    content: "删除银行卡成功",
